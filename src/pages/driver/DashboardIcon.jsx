// ParkChain Dashboard — inline SVG icon set
const PATHS = {
  ...
  'P':        '<rect x="3" y="3" width="18" height="18" rx="3"/><path d="M9 17V7h4a3 3 0 0 1 0 6H9"/>',
};

export default function DashboardIcon({ name, size = 20, stroke = 2, fill = false, className = '', style = {} }) {
